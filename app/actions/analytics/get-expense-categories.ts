...
export default async function getExpenseCategoryBreakdown(
  ...
  try {
    ...
    const url = queryParams.toString()
      ? `/transactions/analytics/categories/expenses?${queryParams.toString()}`
      : "/transactions/analytics/categories/expenses"
