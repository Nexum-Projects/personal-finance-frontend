...
export function getPublicMessages(language: PreferredLanguage): Messages {
  switch (language) {
    case "EN":
      return { ...EN_COMMON_MESSAGES, ...EN_AUTH_MESSAGES } as Messages
    case "PT":
      return { ...PT_COMMON_MESSAGES, ...PT_AUTH_MESSAGES } as Messages
    case "ES":
    default:
      return { ...ES_COMMON_MESSAGES, ...ES_AUTH_MESSAGES } as Messages
  }
}
